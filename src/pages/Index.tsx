  ...
  const products = [
    {
      ...
      icon: Brain,
      details: "Разработка интеллектуальных алгоритмов, нейросетевых моделей и автоматизированных систем принятия решений для анализа данных, предсказательной аналитики и автоматизации.",
      features: ["Компьютерное зрение", "Обработка естественного языка", "Глубокое обучение", "Генеративные модели"]
    },
    {
      id: "gearscs",
      name: "GearSCS",
      ...
      icon: Satellite,
      details: "Спутниковые технологии для глобальной связи, отслеживания и передачи данных в труднодоступных районах, включая IoT и защищённые коммуникации.",
      features: ["Спутниковый интернет", "Глобальная связь", "Шифрованные коммуникации", "IoT"]
    },
    {
      id: "gearci",
      name: "GearCI",
      ...
      features: ["Облачные вычисления", "Распределённые кластеры", "Нейросетевые серверы"]
    },
    {
      id: "gearnet",
      name: "GearNET",
      description: "Децентрализованные Mesh-сети",
      icon: Globe,
      details: "Инновационная технология для децентрализованных коммуникаций на базе Mesh-сетей 2.4 ГГц, обеспечивающая быструю и надежную передачу данных без традиционной инфраструктуры.",
      features: ["Mesh-сети", "Динамическая маршрутизация", "Шифрование", "Минимальная задержка"]
    },
    {
      id: "gearkit",
      name: "GearKit",
      ...
      icon: Bot,
      details: "Разработка автономных роботизированных платформ для промышленного применения, автоматизации процессов и создания гуманоидных роботов с высокой степенью адаптивности.",
